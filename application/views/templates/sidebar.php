<!-- Sidebar -->
<!-- bg-gradient-primary -->
<ul class="navbar-nav <?php // echo "bg-gradient-primary";?> bg-danger sidebar sidebar-dark accordion" style="background-color: #c2280a !important;"
    id="accordionSidebar">

    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>">
    <?php $dashboard = $this->db->get('dashboard')->row_array(1); ?>
